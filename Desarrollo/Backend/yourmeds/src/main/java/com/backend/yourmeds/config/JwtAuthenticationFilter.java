...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        // Verificar con "Bearer " (espacio al final)
        ...
        final String username = jwtUtil.extractUsername(token); // puede lanzar excepción si token inválido

        // Validar sólo si el usuario aún no está autenticado
