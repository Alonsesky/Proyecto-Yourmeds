...
const RegisterSheet = forwardRef<RegisterSheetRef, Props>(({ onRegistered }, ref) => {
  ...
  return (
    ...
    >
      <BottomSheetView style={{ paddingHorizontal: 20, paddingBottom: 24 }}>
        ...
        <Controller
          ...
          render={({ field: { onChange, onBlur, value } }) => (
            <InputLight
              ...
              onBlur={onBlur}
              style={{ borderBottomColor: errors.name ? '#FFD1D1' : 'rgba(255,255,255,0.7)' }}
            />
          )}
        />
        ...
        <Controller
          ...
          render={({ field: { onChange, onBlur, value } }) => (
            <InputLight
              ...
              onChangeText={onChange}
              onBlur={onBlur}
              style={{ borderBottomColor: errors.email ? '#FFD1D1' : 'rgba(255,255,255,0.7)' }}
            />
          )}
        />
        {errors.email && <ErrorMsgLight>{errors.email.message}</ErrorMsgLight>}
          ...
          render={({ field: { onChange, onBlur, value } }) => (
            <>
              <InputLight
                ...
                onChangeText={onChange}
                onBlur={onBlur}
                style={{ borderBottomColor: errors.password ? '#FFD1D1' : 'rgba(255,255,255,0.7)' }}
              />
              {errors.password && <ErrorMsgLight>{errors.password.message}</ErrorMsgLight>}
        ...
        <Controller
          ...
          render={({ field: { onChange, onBlur, value } }) => (
            <InputLight
              ...
              onChangeText={onChange}
              onBlur={onBlur}
              style={{ borderBottomColor: errors.confirm ? '#FFD1D1' : 'rgba(255,255,255,0.7)' }}
            />
          )}
        />
        {errors.confirm && <ErrorMsgLight>{errors.confirm.message}</ErrorMsgLight>}
          ...
          render={({ field: { onChange, onBlur, value } }) => {
            ...
            return (
              <InputLight
                ...
                onChangeText={(text) => onChange(onlyDigits(text).slice(0, 9))}
                onBlur={onBlur}
                style={{ borderBottomColor: errors.rut ? '#FFD1D1' : 'rgba(255,255,255,0.7)' }}
              />
            );
          }}
        />
        ...
        >
          {loadingReg ? <ActivityIndicator /> : <TextoBotonDark>Registrarse</TextoBotonDark>}
        </BotonLight>
      </BottomSheetView>
    </BottomSheet>
  );
...
const CloseText = styled.Text({ color: '#fff', fontSize: 18, fontWeight: 'bold' });
...
const StrengthLabel = styled.Text({ color: '#E6F4FF', fontSize: 12, marginTop: 6, fontWeight: '600' });
